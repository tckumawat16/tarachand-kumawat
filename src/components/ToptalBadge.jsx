...
/**
 * Official Toptal "Top 3% Talent" badge.
 * Converted from Toptal's raw HTML/CSS embed snippet into JSX.
 * The href on the "Hire me" link (including the #AJAeJl tracking
 * fragment) must stay EXACTLY as provided by Toptal — that's the
 * only part their verification system checks for. Everything else
 * (class names, structure) was just adapted to be valid JSX and to
 * avoid colliding with the rest of the site's CSS.
 */
    ...
    <div className="tb-root">
      <div className="tb-hex">
        <div className="tb-inner">
          ...
          <h3 className="tb-title">TOP 3% TALENT</h3>
          <div className="tb-divider" />
          <span className="tb-label">Vetted by</span>
          ...
          <a
            ...
            rel="noreferrer"
            className="tb-cta"
            href="https://www.toptal.com/developers/resume/tarachand-kumawat#AJAeJl"
          >
            Hire me
          </a>
        </div>
